...
export function applyAppearanceToDocument(state: AppearanceState, systemDark?: boolean) {
  ...
  root.style.setProperty("--sidebar", "240 35% 17%");
  root.style.setProperty("--sidebar-foreground", "0 0% 100%");
  root.style.setProperty("--sidebar-muted", "245 18% 78%");
  root.style.setProperty("--sidebar-border", "240 22% 22%");
  root.style.setProperty("--color-sidebar", "#1C1C3A");
