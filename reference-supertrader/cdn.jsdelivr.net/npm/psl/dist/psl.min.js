    ...
    return function i(e, n, t) {
        function m(o, a) {
            if (!n[o]) {
                ...
                s = n[o] = {
                    exports: {}
                }, e[o][0].call(s.exports, function(a) {
                    return m(e[o][1][a] || a)
                }, s, s.exports, i, e, n, t)
            }
            return n[o].exports
        }
        for (var r = "function" == typeof require && require, a = 0; a < t.length; a++) m(t[a]);
        return m
    }({
        1: [function(a, o, s) {
        ...
        2: [function(a, o, t) {
            var m = a("punycode/"),
                r = {};
            r.rules = a("./data/rules.json").map(function(a) {
                return {
                    rule: a,
                    suffix: a.replace(/^(\*\.|\!)/, ""),
                    punySuffix: -1,
            ...
            }), r.endsWith = function(a, o) {
                return -1 !== a.indexOf(o, a.length - o.length)
            }, r.findRule = function(a) {
                var s = m.toASCII(a);
                return r.rules.reduce(function(a, o) {
                    return -1 === o.punySuffix && (o.punySuffix = m.toASCII(o.suffix)), r.endsWith(s, "." + o.punySuffix) || s === o.punySuffix ? o : a
                }, null)
            }, t.errorCodes = {
                ...
                for (var o, s = a.split("."), i = 0; i < s.length; ++i) {
                    if (!(o = s[i]).length) return "LABEL_TOO_SHORT";
                ...
                var o = a.slice(0).toLowerCase(),
                    s = ("." === o.charAt(o.length - 1) && (o = o.slice(0, o.length - 1)), r.validate(o));
                if (s) return {
                    input: a,
                    error: {
                ...
                function e() {
                    return /xn--/.test(o) && (i.domain && (i.domain = m.toASCII(i.domain)), i.subdomain) && (i.subdomain = m.toASCII(i.subdomain)), i
                }
                a = r.findRule(o);
                if (!a) return s.length < 2 ? i : (i.tld = s.pop(), i.sld = s.pop(), i.domain = [i.sld, i.tld].join("."), s.length && (i.subdomain = s.pop()), e());
                i.listed = !0;
                var n = a.suffix.split("."),
                    s = s.slice(0, s.length - n.length);
                return a.exception && s.push(n.shift()), i.tld = n.join("."), s.length && (a.wildcard && (n.unshift(s.pop()), i.tld = n.join(".")), s.length) && (i.sld = s.pop(), i.domain = [i.sld, i.tld].join("."), s.length) && (i.subdomain = s.join(".")), e()
            }, t.get = function(a) {
        ...
        3: [function(a, o, s) {
            ...
            function v(a) {
                var o = [];
                let s = 0;
                for (var i = a.length; s < i;) {
                    var e, n = a.charCodeAt(s++);
                    55296 <= n && n <= 56319 && s < i ? 56320 == (64512 & (e = a.charCodeAt(s++))) ? o.push(((1023 & n) << 10) + (1023 & e) + 65536) : (o.push(n), s--) : o.push(n)
                }
                return o
            }
            ...
            function z(a, o, s) {
                let i = 0;
                for (a = s ? b(a / n) : a >> 1, a += b(a / o); a > p * j >> 1; i += d) a = b(a / p);
                return b(i + (p + 1) * a / (a + e))
            }
            ...
            function u(i) {
                ...
                let n = 0,
                    ...
                    m = i.lastIndexOf("-");
                m < 0 && (m = 0);
                for (let a = 0; a < m; ++a) 128 <= i.charCodeAt(a) && y("not-basic"), o.push(i.charCodeAt(a));
                for (let s = 0 < m ? m + 1 : 0; s < e;) {
                    var r = n;
                    for (let a = 1, o = d;; o += d) {
                        s >= e && y("invalid-input");
                        var p = 48 <= (p = i.charCodeAt(s++)) && p < 58 ? p - 48 + 26 : 65 <= p && p < 91 ? p - 65 : 97 <= p && p < 123 ? p - 97 : d,
                            c = (p >= d && y("invalid-input"), p > b((h - n) / a) && y("overflow"), n += p * a, o <= t ? 1 : o >= t + j ? j : o - t);
                        if (p < c) break;
                        p = d - c;
                        a > b(h / p) && y("overflow"), a *= p
                    }
                    var u = o.length + 1;
                    t = z(n - r, u, 0 == r), b(n / u) > h - a && y("overflow"), a += b(n / u), n %= u, o.splice(n++, 0, a)
                }
            ...
            function k(o) {
                ...
                let e = 128,
                    n = 0,
                    t = 72;
                for (a of o) a < 128 && s.push(w(a));
                var m = s.length;
                let r = m;
                for (m && s.push("-"); r < i;) {
                    let a = h;
                    for (var p of o) p >= e && p < a && (a = p);
                    var c, u = r + 1;
                    a - e > b((h - n) / u) && y("overflow"), n += (a - e) * u, e = a;
                    for (c of o)
                        if (c < e && ++n > h && y("overflow"), c === e) {
                            let o = n;
                            for (let a = d;; a += d) {
                                var k = a <= t ? 1 : a >= t + j ? j : a - t;
                                if (o < k) break;
                                var l = o - k,
                                    g = d - k;
                                s.push(w(f(k + l % g, 0))), o = b(l / g)
                            }
                            s.push(w(f(o, 0))), t = z(n, u, r === m), n = 0, ++r
                        }++n, ++e
                }
                return s.join("")
            }
            var l = {
                ...
                toASCII: function(a) {
                    return c(a, function(a) {
                        return t.test(a) ? "xn--" + k(a) : a
                    })
                },
                toUnicode: function(a) {
                    return c(a, function(a) {
                        return i.test(a) ? u(a.slice(4).toLowerCase()) : a
                    })
                }
            };
            o.exports = l
