...
var n = e.arrayToEnum([`string`, `nan`, `number`, `integer`, `float`, `boolean`, `date`, `bigint`, `symbol`, `function`, `undefined`, `null`, `array`, `object`, `unknown`, `promise`, `void`, `never`, `map`, `set`]),
    r = e => {
        switch (typeof e) {
            case `undefined`:
                return n.undefined;
    ...
    i = e.arrayToEnum([`invalid_type`, `invalid_literal`, `custom`, `invalid_union`, `invalid_union_discriminator`, `invalid_enum_value`, `unrecognized_keys`, `invalid_arguments`, `invalid_return_type`, `invalid_date`, `invalid_string`, `too_small`, `too_big`, `invalid_intersection_types`, `not_multiple_of`, `not_finite`]),
...
var o = (t, r) => {
        ...
        switch (t.code) {
            case i.invalid_type:
                a = t.received === n.undefined ? `Required` : `Expected ${t.expected}, received ${t.received}`;
                break;
...
function l(e, t) {
    let n = c(),
        r = ee({
            ...
            data: e.data,
            path: e.path,
            errorMaps: [e.common.contextualErrorMap, e.schemaErrorMap, n, n === o ? void 0 : o].filter(e => !!e)
        });
...
var y = class {
        ...
        async safeParseAsync(e, t) {
            ...
            return re(n, await (h(i) ? i : Promise.resolve(i)))
        }
        refine(e, t) {
    ...
    ue = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
    de = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
    fe = `^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$`,
    pe, me = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    he = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/,
    ge = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/,
    _e = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/,
    ve = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
    ye = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
    be = `((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))`,
    xe = RegExp(`^${be}$`);
...
var b = class t extends y {
    _parse(t) {
        ...
        for (let n of this._def.checks)
            if (n.kind === `min`) t.data.length < n.value && (a = this._getOrReturnCtx(t, a), l(a, {
                code: i.too_small,
                minimum: n.value,
                type: `string`,
                inclusive: !0,
            ...
            else if (n.kind === `max`) t.data.length > n.value && (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.too_big,
            maximum: n.value,
            type: `string`,
            inclusive: !0,
            ...
            (e || o) && (a = this._getOrReturnCtx(t, a), e ? l(a, {
                code: i.too_big,
                maximum: n.value,
                type: `string`,
                inclusive: !0,
        ...
        } else if (n.kind === `email`) de.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `email`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        else if (n.kind === `emoji`) pe || = new RegExp(fe, `u`), pe.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `emoji`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        else if (n.kind === `uuid`) se.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `uuid`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        else if (n.kind === `nanoid`) ce.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `nanoid`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        else if (n.kind === `cuid`) ie.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `cuid`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        else if (n.kind === `cuid2`) ae.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `cuid2`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        else if (n.kind === `ulid`) oe.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `ulid`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty());
        ...
        } else n.kind === `regex` ? (n.regex.lastIndex = 0, n.regex.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `regex`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty())) : n.kind === `trim` ? t.data = t.data.trim() : n.kind === `includes` ? t.data.includes(n.value, n.position) || (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.invalid_string,
            validation: {
                includes: n.value,
                position: n.position
            ...
            message: n.message
        }), r.dirty()) : n.kind === `toLowerCase` ? t.data = t.data.toLowerCase() : n.kind === `toUpperCase` ? t.data = t.data.toUpperCase() : n.kind === `startsWith` ? t.data.startsWith(n.value) || (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.invalid_string,
            validation: {
                startsWith: n.value
            },
            message: n.message
        }), r.dirty()) : n.kind === `endsWith` ? t.data.endsWith(n.value) || (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.invalid_string,
            validation: {
                endsWith: n.value
            },
            message: n.message
        }), r.dirty()) : n.kind === `datetime` ? we(n).test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.invalid_string,
            validation: `datetime`,
            message: n.message
        }), r.dirty()) : n.kind === `date` ? xe.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.invalid_string,
            validation: `date`,
            message: n.message
        }), r.dirty()) : n.kind === `time` ? Ce(n).test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.invalid_string,
            validation: `time`,
            message: n.message
        }), r.dirty()) : n.kind === `duration` ? ue.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `duration`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty()) : n.kind === `ip` ? Te(t.data, n.version) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `ip`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty()) : n.kind === `jwt` ? Ee(t.data, n.alg) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `jwt`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty()) : n.kind === `cidr` ? De(t.data, n.version) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `cidr`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty()) : n.kind === `base64` ? ve.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `base64`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty()) : n.kind === `base64url` ? ye.test(t.data) || (a = this._getOrReturnCtx(t, a), l(a, {
            validation: `base64url`,
            code: i.invalid_string,
            message: n.message
        }), r.dirty()) : e.assertNever(n);
        return {
            status: r.value,
            value: t.data
        }
...
var ke = class t extends y {
    ...
    _parse(t) {
        ...
        let r, a = new u;
        for (let n of this._def.checks) n.kind === `int` ? e.isInteger(t.data) || (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.invalid_type,
            expected: `integer`,
            received: `float`,
            message: n.message
        }), a.dirty()) : n.kind === `min` ? (n.inclusive ? t.data < n.value : t.data <= n.value) && (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.too_small,
            minimum: n.value,
            type: `number`,
            ...
            exact: !1,
            message: n.message
        }), a.dirty()) : n.kind === `max` ? (n.inclusive ? t.data > n.value : t.data >= n.value) && (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.too_big,
            maximum: n.value,
            type: `number`,
            inclusive: n.inclusive,
            exact: !1,
            message: n.message
        }), a.dirty()) : n.kind === `multipleOf` ? Oe(t.data, n.value) !== 0 && (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.not_multiple_of,
            multipleOf: n.value,
            message: n.message
        }), a.dirty()) : n.kind === `finite` ? Number.isFinite(t.data) || (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.not_finite,
            message: n.message
        }), a.dirty()) : e.assertNever(n);
        return {
            status: a.value,
            value: t.data
        }
...
var Ae = class t extends y {
    ...
    _parse(t) {
        ...
        let r, a = new u;
        for (let n of this._def.checks) n.kind === `min` ? (n.inclusive ? t.data < n.value : t.data <= n.value) && (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.too_small,
            type: `bigint`,
            minimum: n.value,
            inclusive: n.inclusive,
            ...
            inclusive: n.inclusive,
            message: n.message
        }), a.dirty()) : n.kind === `multipleOf` ? t.data % n.value !== BigInt(0) && (r = this._getOrReturnCtx(t, r), l(r, {
            code: i.not_multiple_of,
            multipleOf: n.value,
            message: n.message
        }), a.dirty()) : e.assertNever(n);
...
var Me = class t extends y {
    _parse(t) {
        ...
        if (Number.isNaN(t.data.getTime())) return l(this._getOrReturnCtx(t), {
            code: i.invalid_date
        }), d;
        let r = new u,
            a;
        for (let n of this._def.checks) n.kind === `min` ? t.data.getTime() < n.value && (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.too_small,
            message: n.message,
            inclusive: !0,
            exact: !1,
            minimum: n.value,
            type: `date`
        }), r.dirty()) : n.kind === `max` ? t.data.getTime() > n.value && (a = this._getOrReturnCtx(t, a), l(a, {
            code: i.too_big,
            message: n.message,
            inclusive: !0,
            exact: !1,
...
var E = class e extends y {
    _parse(e) {
        let {
            ctx: t,
            status: r
        } = this._processInputParams(e), a = this._def;
        if (t.parsedType !== n.array) return l(t, {
            code: i.invalid_type,
            expected: n.array,
            received: t.parsedType
        }), d;
        ...
        if (a.minLength !== null && t.data.length < a.minLength.value && (l(t, {
            ...
            }), r.dirty()), t.common.async) return Promise.all([...t.data].map((e, n) => a.type._parseAsync(new _(t, e, t.path, n)))).then(e => u.mergeArray(r, e));
...
function D(e) {
    ...
    } else if (e instanceof E) return new E({ ...e._def,
        type: D(e.element)
    });
    else if (e instanceof B) return B.create(D(e.unwrap()));
    else if (e instanceof V) return V.create(D(e.unwrap()));
    else if (e instanceof N) return N.create(e.items.map(e => D(e)));
    else return e
}
var O = class t extends y {
    constructor() {
    ...
    _parse(e) {
        ...
        if (this._def.catchall instanceof T) {
            ...
            else if (e === `strict`) s.length > 0 && (l(r, {
    ...
    strict(e) {
        return g.errToObj, new t({ ...this._def,
            unknownKeys: `strict`,
            ...e === void 0 ? {} : {
                errorMap: (t, n) => {
    ...
    required(n) {
        ...
        for (let t of e.objectKeys(this.shape))
            if (n && !n[t]) r[t] = this.shape[t];
                ...
                let e = this.shape[t];
                for (; e instanceof B;) e = e._def.innerType;
                r[t] = e
            }
        return new t({ ...this._def,
            shape: () => r
    ...
    keyof() {
        return Be(e.objectKeys(this.shape))
    }
};
O.create = (e, t) => new O({
    shape: () => e,
...
var A = t => t instanceof P ? A(t.schema) : t instanceof z ? A(t.innerType()) : t instanceof F ? [t.value] : t instanceof I ? t.options : t instanceof L ? e.objectValues(t.enum) : t instanceof H ? A(t._def.innerType) : t instanceof S ? [void 0] : t instanceof C ? [null] : t instanceof B ? [void 0, ...A(t.unwrap())] : t instanceof V ? [null, ...A(t.unwrap())] : t instanceof He || t instanceof W ? A(t.unwrap()) : t instanceof U ? A(t._def.innerType) : [],
    Fe = class e extends y {
        _parse(e) {
            let {
                ctx: t
            } = this._processInputParams(e);
            if (t.parsedType !== n.object) return l(t, {
                code: i.invalid_type,
                expected: n.object,
                received: t.parsedType
            }), d;
...
function j(t, i) {
    ...
    } else if (a === n.date && o === n.date && +t == +i) return {
        valid: !0,
        data: t
    };
    else return {
...
var M = class extends y {
    _parse(e) {
        let {
            ...
            let a = j(e.value, r.value);
            return a.valid ? ((ne(e) || ne(r)) && t.dirty(), {
                status: t.value,
                value: a.data
            }) : (l(n, {
...
M.create = (e, t, n) => new M({
    left: e,
    right: t,
    typeName: G.ZodIntersection,
    ...v(n)
});
var N = class e extends y {
    _parse(e) {
        let {
            status: t,
            ctx: r
        } = this._processInputParams(e);
        if (r.parsedType !== n.array) return l(r, {
            code: i.invalid_type,
            expected: n.array,
...
var Ie = class e extends y {
        ...
        _parse(e) {
            ...
            if (r.parsedType !== n.object) return l(r, {
                code: i.invalid_type,
                expected: n.object,
                received: r.parsedType
            }), d;
    ...
    Le = class extends y {
        ...
        _parse(e) {
            ...
            if (r.parsedType !== n.map) return l(r, {
                code: i.invalid_type,
                expected: n.map,
                received: r.parsedType
            }), d;
...
var Re = class e extends y {
    _parse(e) {
        let {
            status: t,
            ctx: r
        } = this._processInputParams(e);
        if (r.parsedType !== n.set) return l(r, {
            code: i.invalid_type,
            expected: n.set,
            received: r.parsedType
        }), d;
...
var ze = class e extends y {
        ...
        _parse(e) {
            ...
            if (t.parsedType !== n.function) return l(t, {
                code: i.invalid_type,
                expected: n.function,
                received: t.parsedType
            }), d;
...
var I = class t extends y {
    ...
    extract(e, n = this._def) {
        return t.create(e, { ...this._def,
            ...n
        })
    }
    exclude(e, n = this._def) {
        return t.create(this.options.filter(t => !e.includes(t)), { ...this._def,
            ...n
        })
    }
};
...
var L = class extends y {
    _parse(t) {
        ...
        if (this._cache || = new Set(e.getValidEnumValues(this._def.values)), !this._cache.has(t.data)) {
            let t = e.objectValues(r);
            return l(a, {
                received: a.data,
                code: i.invalid_enum_value,
...
var R = class extends y {
    ...
    _parse(e) {
        ...
        return t.parsedType !== n.promise && t.common.async === !1 ? (l(t, {
            code: i.invalid_type,
            expected: n.promise,
            received: t.parsedType
        }), d) : p((t.parsedType === n.promise ? t.data : Promise.resolve(t.data)).then(e => this._def.type.parseAsync(e, {
            path: t.path,
            errorMap: t.common.contextualErrorMap
        })))
    }
...
var z = class extends y {
    ...
    _parse(t) {
        let {
            status: n,
            ctx: r
        } = this._processInputParams(t), i = this._def.effect || null, a = {
            addIssue: e => {
        ...
        if (a.addIssue = a.addIssue.bind(a), i.type === `preprocess`) {
            ...
            if (r.common.async) return Promise.resolve(e).then(async e => {
                ...
                let t = await this._def.schema._parseAsync({
                    data: e,
                    path: r.path,
                    parent: r
                });
                return t.status === `aborted` ? d : t.status === `dirty` || n.value === `dirty` ? f(t.value) : t
            }); {
                if (n.value === `aborted`) return d;
        ...
        if (i.type === `refinement`) {
            ...
            if (r.common.async === !1) {
                ...
                return t.status === `aborted` ? d : (t.status === `dirty` && n.dirty(), e(t.value), {
                    status: n.value,
                    value: t.value
                })
                ...
                path: r.path,
                parent: r
            }).then(t => t.status === `aborted` ? d : (t.status === `dirty` && n.dirty(), e(t.value).then(() => ({
                status: n.value,
                value: t.value
            }))))
        }
        if (i.type === `transform`)
            if (r.common.async === !1) {
                ...
                if (t instanceof Promise) throw Error(`Asynchronous transform encountered during synchronous parse operation. Use .parseAsync instead.`);
                return {
                    status: n.value,
                    value: t
                }
                ...
                path: r.path,
                parent: r
            }).then(e => m(e) ? Promise.resolve(i.transform(e.value, a)).then(e => ({
                status: n.value,
                value: e
            })) : d);
        e.assertNever(i)
...
z.create = (e, t, n) => new z({
    schema: e,
    typeName: G.ZodEffects,
    effect: t,
    ...v(n)
}), z.createWithPreprocess = (e, t, n) => new z({
    schema: t,
    effect: {
        type: `preprocess`,
        transform: e
    ...
    Ue = class e extends y {
        _parse(e) {
            ...
            if (n.common.async) return (async () => {
                ...
                return e.status === `aborted` ? d : e.status === `dirty` ? (t.dirty(), f(e.value)) : this._def.out._parseAsync({
                    data: e.value,
                    path: n.path,
                    parent: n
                })
...
Ve.create, Ae.create;
var J = je.create;
Me.create, x.create, S.create, C.create, Ne.create, w.create, T.create, Pe.create;
var Y = E.create,
    X = O.create;
O.strictCreate;
var Z = k.create;
Fe.create, M.create, N.create, Ie.create, Le.create, Re.create, ze.create, P.create;
var We = F.create,
    Q = I.create;
L.create, R.create, z.create, B.create, V.create, z.createWithPreprocess, Ue.create;
var Ge = X({
        id: Z([q(), K()]),
        symbol: K().nullable(),
        entry_price: q().nullable().optional(),
        exit_price: q().nullable().optional(),
        quantity: q().nullable().optional(),
        pnl: q().nullable().optional(),
        net_pnl: q().nullable().optional(),
        gross_pnl: q().nullable().optional(),
        net_pnl_economic: q().nullable().optional(),
        net_roi: q().nullable().optional(),
        fees_comms: q().nullable().optional(),
        side: K().nullable().optional(),
        trade_type: K().nullable().optional(),
        status: K().nullable().optional(),
        entry_date: K().nullable().optional(),
        entry_date_time: K().nullable().optional(),
        exit_date: K().nullable().optional(),
        exit_date_time: K().nullable().optional(),
        portfolio_id: q().nullable().optional(),
        instrument_type: K().nullable().optional(),
        asset_type: K().nullable().optional(),
        strategies: Y(K()).nullish(),
        mistakes: Y(K()).nullish(),
        improvements: Y(K()).nullish(),
        notes: K().nullable().optional(),
        chart_urls: Y(K()).nullish(),
        is_reviewed: J().optional(),
        leverage: q().nullable().optional(),
        quote: X({
            symbol_code: K().optional(),
            last_price: q().optional(),
            status: K().optional(),
            fetched_at: K().optional(),
            is_stale: J().optional()
        }).nullable().optional()
    }).passthrough(),
    Ke = X({
        trades: Y(Ge).optional()
    }).passthrough(),
    qe = Z([Y(Ge), Ke]);
...
function Je(e) {
    ...
    if (!t.success) return [];
    let n = t.data;
    return Array.isArray(n) ? n : n.trades ? ? []
}
var Ye = X({
        access_token: K(),
        refresh_token: K(),
    ...
    Xe = X({
        valid: J().optional(),
        message: K().optional(),
        has_active_subscription: J().optional(),
        trade_count: q().optional(),
        free_limit_reached: J().optional(),
        is_admin: J().optional(),
        is_super_admin: J().optional()
    }).passthrough(),
    Ze = X({
        id: Z([K(), q()]).optional(),
        email: K().optional(),
        name: K().optional(),
        first_name: K().nullable().optional(),
        last_name: K().nullable().optional(),
        image_url: K().nullable().optional(),
        is_admin: J().optional(),
        is_super_admin: J().optional()
    }).passthrough(),
    Qe = X({
        accountType: Q([`personal`, `evaluation`, `funded`, `scaling`]).optional(),
        firmName: K().optional(),
        phase: Z([We(1), We(2), We(`funded`)]).optional(),
        startDate: K().optional(),
        drawdownType: Q([`trailing-eod`, `trailing-intraday`, `static`, `trailing-to-static`]).optional(),
        maxDrawdownAmount: q().optional(),
        dailyLossLimit: q().optional(),
        profitTarget: q().optional(),
        minTradingDays: q().optional(),
        consistencyRulePct: q().optional(),
        payoutBuffer: q().optional(),
        trailingLockLevel: q().optional(),
        maxDailyContractLimit: q().optional()
    }).passthrough(),
    $e = Z([q(), K().transform(Number)]),
    et = X({
        currency: K().optional(),
        initial_account_balance: $e.optional(),
        default_fee_per_trade: $e.optional(),
        default_commission: $e.optional(),
        account_type: Q([`personal`, `evaluation`, `funded`, `scaling`]).optional(),
        prop_firm: Qe.optional().nullable()
    }).passthrough(),
    tt = X({
        id: q(),
        name: K(),
        description: K().optional().nullable(),
        is_default: J().optional(),
        created_at: K().optional(),
        settings: Z([et, K()]).optional().nullable()
    }).passthrough(),
    nt = X({
        portfolios: Y(tt).optional()
    }).passthrough(),
    $ = X({
        best: q(),
        current: q(),
    ...
    it = X({
        today_closed_trades: q(),
        today_total_pnl: q(),
        today_review_count: q().optional(),
        pnl_change_percentage: q().optional(),
        previous_day_total_pnl: q().optional(),
        current_win_streak: q().optional(),
        current_loss_streak: q().optional(),
        journaling_streak_weeks: q().optional(),
        premarket_streak_days: q().optional()
    }),
    at = X({
        id: q(),
        ticker: K(),
    ...
    ot = X({
        ytd_return_pct: q().nullable().optional(),
        ytd_return_label: K().nullable().optional(),
        days_traded_this_month: q().optional(),
        total_forex_pips: q().optional(),
        has_forex_trades: J().optional(),
        trade_count: q().optional(),
        avg_win: q().optional(),
        avg_loss: q().optional(),
        best_trade: at.nullable().optional(),
        worst_trade: at.nullable().optional(),
        strategy_breakdown: Y(X({
            name: K(),
            win_rate: q(),
            trades: q(),
            total_pnl: q()
    ...
    st = X({
        total_pnl: q(),
        total_profit: q().optional(),
        total_loss: q().optional(),
        total_wins: q(),
        total_losses: q(),
        trade_win_percentage: q(),
        profit_factor: Z([q(), K()]),
        yearly_goal_percentage: q().optional(),
        max_drawdown: q().optional(),
        cumulative_pnl: Y(X({
            date: K(),
            cumulative: q()
        })).optional(),
        ...
        today_view: ot.optional(),
        avg_win: q().optional(),
        avg_loss: q().optional(),
        biggest_winner: q().optional(),
        biggest_loser: q().optional(),
        today_trade_count: q().optional()
    }).passthrough(),
    ct = X({
        success: J().optional(),
        goals: X({
            yearly_goal: q(),
            monthly_goal: q().nullable().optional(),
            weekly_goal: q(),
            number_of_trades: q().nullable().optional()
        }).nullable().optional(),
        message: K().optional()
    }),
    lt = X({
    ...
    ut = X({
        ...
        created_at: K().optional(),
        goal: X({
            monthly_target_usd: q(),
            rules: Y(K())
        }),
        risk: X({
            min_rr: q(),
            max_daily_loss_usd: q(),
            max_trades_per_day: q(),
            risk_per_trade_pct: q(),
            rules: Y(K())
        }),
        style: X({
            style_type: Q([`day`, `swing`, `scalping`, `position`]),
            duration_from: K(),
            duration_to: K(),
            instruments: Y(K()),
            trading_days: Y(q()),
...
X({
    timezone: K().optional(),
    language: K().optional(),
    date_format: K().optional(),
    theme: K().optional(),
    is_net_profit_selected: J().optional()
}).passthrough();
export {
    it as a, ct as c, nt as d, ot as f, Xe as i, Ye as l, rt as n, st as o, dt as p, tt as r, Je as s, Ze as t, et as u
};