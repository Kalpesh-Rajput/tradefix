...
var t = `-`,
    ...
    l = e => e.isThemeGetter,
    u = (e, t) => t ? e.map(([e, n]) => [e, n.map(e => typeof e == `string` ? t + e : typeof e == `object` ? Object.fromEntries(Object.entries(e).map(([e, n]) => [t + e, n])) : e)]) : e,
    d = e => {
        if (e < 1) return {
            get: () => void 0,
            set: () => {}
    ...
    p = e => {
        ...
        } = e, r = t.length === 1, i = t[0], a = t.length, o = e => {
            let n = [],
                o = 0,
                s = 0,
                c;
    ...
    X = b(() => {
        ...
        return {
            ...
            classGroups: {
                ...
                leading: [{
                    leading: [`none`, `tight`, `snug`, `normal`, `relaxed`, `loose`, A, I]
                }],
                "list-image": [{
                    "list-image": [`none`, I]
                }],
