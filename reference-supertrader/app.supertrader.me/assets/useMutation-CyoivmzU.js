...
var d = class extends u {#
    ...
    r;
    constructor(e) {
        super(), this.#e = e.client, this.mutationId = e.mutationId, this.#n = e.mutationCache, this.#t = [], this.state = e.state || f(), this.setOptions(e.options), this.scheduleGc()
    }
    setOptions(e) {
...
function h(e, t) {
    let r = c(t),
        [i] = m.useState(() => new p(r, e));
    m.useEffect(() => {
        i.setOptions(e)
    }, [i, e]);
    let a = m.useSyncExternalStore(m.useCallback(e => i.subscribe(l.batchCalls(e)), [i]), () => i.getCurrentResult(), () => i.getCurrentResult()),
        s = m.useCallback((e, t) => {
            i.mutate(e, t).catch(n)
        }, [i]);
    if (a.error && o(i.options.throwOnError, [a.error])) throw a.error;
    return { ...a,
        mutate: s,
