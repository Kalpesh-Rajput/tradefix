...
function a(e, t) {
    let n = c.get(t);
    return n || (n = new WeakMap, c.set(t, n)), n.get(e) || n.set(e, new t), n.get(e)
}
class d {
    t;
    i = 0;
    ...
    p = e => {
        if ("hidden" === document.visibilityState) {
            if ("visibilitychange" === e.type)
                for (const e of u) e();
            isFinite(l) || (l = "visibilitychange" === e.type ? e.timeStamp : 0, removeEventListener("prerenderingchange", p, !0))
        }
    },
    g = () => {
        if (l < 0) {
            const e = o(),
                n = document.prerendering ? void 0 : globalThis.performance.getEntriesByType("visibility-state").find(t => "hidden" === t.name && t.startTime >= e) ? .startTime;
            l = n ? ? m(), addEventListener("visibilitychange", p, !0), addEventListener("prerenderingchange", p, !0), t(() => {
                setTimeout(() => {
                    l = m()
                })
            })
        ...
        T(f(() => {
            ...
            const l = a(s, d),
                u = e => {
                    ...
                    l.i > f.value && (f.value = l.i, f.entries = l.o, c())
                },
                m = h("layout-shift", u);
            m && (c = n(e, f, E, s.reportAllChanges), o.onHidden(() => {
                u(m.takeRecords()), c(!0)
            }), t(() => {
                l.i = 0, f = r("CLS", 0), c = n(e, f, E, s.reportAllChanges), i(c)
            }), setTimeout(c))
        }))
    };
let L = 0,
            ...
            const d = a(i, k),
                f = e => {
                    A(() => {
                        ...
                        const t = d.T();
                        t && t.L !== c.value && (c.value = t.L, c.entries = t.entries, o())
                    })
                },
                l = h("event", f, {
                    durationThreshold: i.durationThreshold ? ? 40
                });
            o = n(e, c, B, i.reportAllChanges), l && (l.observe({
                type: "first-input",
                buffered: !0
            }), s.onHidden(() => {
                f(l.takeRecords()), o(!0)
...
const N = [2500, 4e3],
        ...
        v(() => {
            ...
            const u = a(s, q),
                m = e => {
                    ...
                    for (const t of e) u.h(t), t.startTime < c.firstHiddenTime && (l.value = Math.max(t.startTime - o(), 0), l.entries = [t], d())
                },
                p = h("largest-contentful-paint", m);
            if (p) {
                d = n(e, l, N, s.reportAllChanges);
                const o = f(() => {
                ...
                t(t => {
                    l = r("LCP"), d = n(e, l, N, s.reportAllChanges), i(() => {
                        l.value = performance.now() - t.timeStamp, d(!0)
                    })
                })
            }
        })
    ...
    H = [800, 1800],
    O = e => {
        document.prerendering ? v(() => O(e)) : "complete" !== document.readyState ? addEventListener("load", () => O(e), !0) : setTimeout(e)
    },
    W = (e, i = {}) => {
        let c = r("TTFB"),
...
export {
    E as CLSThresholds, y as FCPThresholds, B as INPThresholds, N as LCPThresholds, H as TTFBThresholds, b as onCLS, T as onFCP, S as onINP, x as onLCP, W as onTTFB
};